...
\title{Einführung in die Sprachwissenschaft\\
11.~Relationen und Prädikate}
\author{Roland Schäfer}
\institute{Deutsche und niederländische Philologie\\Freie Universität Berlin}
\date{Wintersemester 2018/2019\\22.~Januar 2019}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.9\textwidth]{feilke1}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.9\textwidth]{feilke2}
\end{frame}
