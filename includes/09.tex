...
\begin{frame}
  ...
  \begin{exe}
    ...
    \begin{xlist}
      ...
      \pause
      \ex{Gabriele malt \orongsch{[einen ganzen Tag]}.}
      \pause
...
\begin{frame}
  ...
  \begin{exe}
    \ex 
    \begin{xlist}
      \ex[ ]{Gabriele isst \orongsch{[einen ganzen Tag]} Walnüsse.}
    \pause
      \ex[ ]{Gabriele läuft \orongsch{[einen ganzen Tag]}.}
      \pause
      \ex[ ]{Gabriele backt ihrer Schwester \orongsch{[einen ganzen Tag]} Stollen.}
      \pause
      \ex[ ]{Gabriele litt \orongsch{[einen ganzen Tag]} unter Sonnenbrand.}
    \end{xlist}
    \pause\Halbzeile
    \ex 
    \begin{xlist}
