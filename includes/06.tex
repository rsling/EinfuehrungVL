...
\begin{frame}
  ...
  \pause
  \begin{center}
    \includegraphics[width=0.6\textwidth]{\GRAPHPATH/kasusschule1}
  \end{center}
...
\begin{frame}
  ...
  Wozu ist so ein Unterricht gut?
  \begin{center}
    \includegraphics[width=0.6\textwidth]{\GRAPHPATH/kasusschule2}
  \end{center}
  \tiny \citet[36--37]{Gramzowemden2002}, zitiert nach \citet[257--258]{Bredel2013}
\end{frame}
...
\begin{frame}
  ...
  Wozu ist so ein Unterricht gut?
  \begin{center}
    \includegraphics[width=0.6\textwidth]{\GRAPHPATH/kasusschule3}
  \end{center}
  \tiny \citet[36--37]{Gramzowemden2002}, zitiert nach \citet[257--258]{Bredel2013}
\end{frame}
