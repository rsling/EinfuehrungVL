...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item \alert{\dots nur bei zugrundeliegendem Anfangsrand-Konsonanten}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \Zeile
  \begin{itemize}[<+->]
    \item \textit{bläulichere} /blɔ͡ʏlɪçəʁə/ $\Rightarrow$ [ˈblɔ͡ʏ.lɪ.çə.ʁə]
    \item \textit{Neunziger} /nɔ͡ʏnt͡sɪgəʁ/ $\Rightarrow$ [ˈnɔ͡ʏn.t͡sɪ.gɐ]
    \item \textit{unterschiedliche} /ʊntəʁʃidlɪçə/ $\Rightarrow$ [ˈʔʊn.tɐ.ʃiːd.lɪ.çə]
  \end{itemize}
  \pause
