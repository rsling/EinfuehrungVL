...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.8\textwidth]{img/gortys}\\
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.55\textwidth]{img/genji1}\\
...
\begin{frame}
  {Scriptio continua: Genji no Monogatari}
  \centering
  \includegraphics[width=0.55\textwidth]{img/genji3}\\
  {\tiny (\citealt{Rickmeyer1991}; 源氏物語:きりつぼ, ca. 1000 u.\,Zr., Manuskript (青表紙証本) ca.\ 1200 u.\,Zr.}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.8\textwidth]{img/merseburg}\\[0.5\baselineskip]
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.45\textwidth]{img/agathon1e}\\[0.5\baselineskip]
...
\begin{frame}
  {Die Entwicklung von Schreibprinzipien}
  \centering
  \includegraphics[width=0.45\textwidth]{img/agathon2e}\\[0.5\baselineskip]
  {\tiny Wieland, Christoph Martin: Geschichte des Agathon. Bd.\ 1. Frankfurt (Main) u.\,a., 1766. In: Deutsches Textarchiv\\[-1\baselineskip]
    \url{http://www.deutschestextarchiv.de/wieland_agathon01_1766>}}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item \raisebox{-.2\height}{\includegraphics[width=1.25em]{img/emoji_mourning}}
  \end{itemize}
\end{frame}
    ...
    \item Fällt Ihnen was auf?
      \begin{itemize}[<+->]
        ...
        \item Aber viele Adjektive sind doch gar nicht prädikativ verwendbar.
          \Halbzeile
%        \item[ ] \raisebox{-0.5\height}{\includegraphics[width=3em]{img/doh}}
        \item[ ] \raisebox{-0.5\height}{\includegraphics[height=4em]{img/doh_blur}}
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.65\textwidth]{img/adjektive1_blur}
%  \includegraphics[width=0.65\textwidth]{img/adjektive1}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.7\textwidth]{img/adjektive2_blur}
%  \includegraphics[width=0.7\textwidth]{img/adjektive2}
\end{frame}
...
\begin{frame}
  {Folgen sprachlicher Diskriminierung und Segregation}
  \pause
  \centering
  \includegraphics[width=0.65\textwidth]{img/nyt_blur}\\
  %\includegraphics[width=0.65\textwidth]{img/nyt}\\
  \Halbzeile
  {\tiny \url{https://www.nytimes.com/2019/01/25/us/black-dialect-courtrooms.html} (25. Januar 2019)}
\end{frame}
...
\begin{frame}<handout:0>[noframenumbering]
  ...
  \Halbzeile
  \pause
  \onslide<10-> Rechnen Sie außerdem damit, dass Ihnen diese Liste demnächst\\
  zur Verfügung gestellt wird. Wenn Sie jetzt statt zuzuhören\\
  fotografiert haben, wissen Sie aber evtl.\ nicht, was gemeint ist.
\end{frame}
