...
%        \item[ ] \raisebox{-0.5\height}{\includegraphics[width=3em]{graphics/doh}}
        \item[ ] \raisebox{-0.5\height}{\includegraphics[height=4em]{graphics/doh_blur}}
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.65\textwidth]{graphics/nyt_blur}\\
  %\includegraphics[width=0.65\textwidth]{graphics/nyt}\\
  \Halbzeile
