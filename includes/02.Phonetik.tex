...
\title{Einführung in die Sprachwissenschaft\\2.~Phonetik}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \vspace{\baselineskip}
  \item \rot{Die Grammatik für Studierende des Lehramts ist eine völlig andere\\
      als die, die sie später an Schulkinder und Jugendliche vermitteln!}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.75\textwidth]{Fragebogen/01}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.75\textwidth]{Fragebogen/02}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.75\textwidth]{Fragebogen/03}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.75\textwidth]{Fragebogen/04}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.75\textwidth]{Fragebogen/05}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.6\textwidth]{Fragebogen/notenspiegel}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.6\textwidth]{Fragebogen/semester}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[width=0.6\textwidth]{Fragebogen/prozentverteilung}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[height=0.7\textheight]{ueberblick}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \centering
  \includegraphics[height=0.7\textheight]{mundraum}
\end{frame}
